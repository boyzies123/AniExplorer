...
const ToggleButton = () =>{
    ...
    return(
        <div className="toggle-button">
            <input type="checkbox" id="dark-mode" checked={darkMode} onChange={() => setDarkMode(!darkMode)}></input>
            <label id="toggle" for="dark-mode">
                {/* Light mode icon */}
                <svg className="light" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Dark mode icon */}
                <svg className= "dark"width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
